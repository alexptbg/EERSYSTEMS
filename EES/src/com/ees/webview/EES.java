...
**/
    ...
    public class EES extends Activity implements OnSharedPreferenceChangeListener {
        WebView mWebView;
        ...
        String MAIN_ADD = "http://eesystems.net/pirintex/";
        ...
        private class MyWebViewClient extends WebViewClient {
    		...
    		public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(EES.this);
		...
		public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,String key) {
			...
			Toast.makeText(EES.this,EES.this.getResources().getString(R.string.options_saved),
	    ...
	    public class WebAppInterface {
	        ...
	        public void Notify(String toast) {
	            ...
	            if (active == true) {
		        	...
		        	//BACK INTENT
		            Intent targetIntent = new Intent(EES.this,EES.class);
		            targetIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP |Intent.FLAG_ACTIVITY_SINGLE_TOP);
		            PendingIntent contentIntent = PendingIntent.getActivity(EES.this,0,targetIntent,PendingIntent.FLAG_UPDATE_CURRENT);
