        ...
        <div class="content">
            ...
            <div class="workplace">
                    ...
                    <div class="span12">
                        <div class="head clearfix">
                            ...
                            <ul class="buttons">
                                ...
                                <li class="tip-" title="<?php echo get_lang($lang, 'td57'); ?>">
                                    <a target="_blank" href="open_t.php?line=<?=$line?>&lang=<?=$lang?>" class="isw-list"></a>
                                </li>
                                <li class="tip-" title="<?php echo get_lang($lang, 'td41'); ?>">
                                    <a target="_blank" href="print_table.php?line=<?=$line?>&lang=<?=$lang?>" class="isw-print"></a>
                                </li>
                            </ul>
                        </div>
                        <div class="block">
				            <?php get_line_data($lang,$line,$l); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row-fluid">
                    <div class="span3">
                        <div class="head clearfix">
                            <i class="fa fa-power-off fa-1x"></i><span><?php echo get_lang($lang, 'td42'); ?></span>
                        </div>
                        <div class="block">                        
							<?php get_dis_controllers($line); ?>
                        </div>
                    </div>
                    <div class="span4">
                        <div class="head clearfix">
                            <i class="fa fa-check-circle fa-1x"></i><span><?php echo get_lang($lang, 'td43'); ?></span>
                        </div>
                        <div class="block">                        
                            <?php get_new_controllers($line); ?>
                        </div>
                    </div>                                   
                    <div class="span5">
                        <div class="head clearfix">
                        ...
                        <div class="block">                        
                            <?php get_stats_controllers($line,$lang); ?>
                        </div>
                    </div>                    
                </div>  
                <div class="dr"><span></span></div>
