        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="head clearfix">
                            <i class="fa fa-dashboard fa-1x"></i><span><?=$line?> - <?php echo get_lang($lang, 'Pressure'); ?></span>
                            <ul class="buttons">
                                ...
                                <li class="tip_" title="<?php echo get_lang($lang, 'chart2'); ?>">
                                    <a target="_blank" href="print_chart_pressure.php?lang=<?=$lang?>&line=<?=$line?>&inv=<?=$inv?>" class="isw-print"></a>
                                </li>
                            </ul>
                        </div>
