                ...
                <div class="row-fluid">
                    <div class="span6">
                        <div class="head clearfix">
                            ...
                            <ul class="buttons">
                                <li class="tip-" title="<?php echo get_lang($lang, 'Settings'); ?>">
                                    <a href="setup/klima.php?lang=<?=$lang?>&line=Boss1&id=5&inv=36&sys=klima" class="isw-settings"></a>
                                </li>
                                <li class="tip-" title="<?php echo get_lang($lang, 'td2'); ?>">
                                    <a href="klimadata.php?lang=<?=$lang?>&line=Boss1&name=BOSS1_COOLING_SYSTEM" class="isw-graph"></a>
                                </li>
                            </ul>
                        </div>
                        <div class="block-fluid">
                            <?php get_klima($lang,'BOSS1_COOLING_SYSTEM','Boss1','5'); ?>
                        </div>
                    </div>
                    <div class="span6">
                        <div class="head clearfix">
                            ...
                            <ul class="buttons">
                                <li class="tip-" title="<?php echo get_lang($lang, 'Settings'); ?>">
                                    <a href="setup/klima.php?lang=<?=$lang?>&line=Boss2&id=4&inv=45&sys=klima" class="isw-settings"></a>
                                </li>
                                <li class="tip-" title="<?php echo get_lang($lang, 'td2'); ?>">
                                    <a href="klimadata.php?lang=<?=$lang?>&line=Boss2&name=BOSS2_COOLING_SYSTEM" class="isw-graph"></a>
                                </li>
                            </ul>
                        </div>
                        <div class="block-fluid">
                            <?php get_klima($lang,'BOSS2_COOLING_SYSTEM','Boss2','4'); ?>
                        </div>
                    </div>			 
                </div>
                ...
                <div class="row-fluid">
                    <div class="span6">
                        <div class="head clearfix">
                            ...
                            <ul class="buttons">
                                <li class="tip-" title="<?php echo get_lang($lang, 'Settings'); ?>">
                                    <a href="setup/klima.php?lang=<?=$lang?>&line=Boss1&id=4&inv=35&sys=klima" class="isw-settings"></a>
                                </li>
                                <li class="tip-" title="<?php echo get_lang($lang, 'td2'); ?>">
                                    <a href="klimadata.php?lang=<?=$lang?>&line=Boss1&name=BOSS1_SYSTEM_3/4" class="isw-graph"></a>
                                </li>
                            </ul>
                        </div>
                        <div class="block-fluid">
                            <?php get_klima($lang,'BOSS1_SYSTEM_3/4','Boss1','4'); ?>
                        </div>
                    </div>
                </div>
                <div class="dr"><span></span></div>
