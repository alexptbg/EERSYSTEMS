...
include('includes/server_functions.php');
$line = ""; $kline = "";
//phpinfo();
        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    ...
                    <div class="span6">
                        <div class="head clearfix">
                            <i class="fa fa-info-circle fa-1x"></i><span><?php echo get_lang($lang, 'inter39'); ?></span>
                        </div>
                        <div class="block-fluid">
                            <?php get_server_info($lang,DB_NAME); ?>
                        </div>
						<div class="dr"><span></span></div>
                        <div class="head clearfix">
                            <i class="fa fa-hdd-o fa-1x"></i><span><?php echo get_lang($lang, 'inter46'); ?></span>
                        </div>
                        <div class="block-fluid">
                            <?php disks_widget($lang); ?>
                        </div>
                    </div>				 
                </div>
				<div class="dr"><span></span></div>
                <div class="row-fluid">
                    <div class="span6">
                        <div class="head clearfix">
                            <i class="fa fa-info-circle fa-1x"></i><span><?php echo get_lang($lang, 'inter14'); ?></span>
                        </div>
                        <div class="block-fluid">
                            <?php get_cpu_chart($lang); ?>
                        </div>
                    </div>
                    <div class="span6">
                        <div class="head clearfix">
                            <i class="fa fa-info-circle fa-1x"></i><span><?php echo get_lang($lang, 'inter11'); ?></span>
                        </div>
                        <div class="block-fluid">
                            <?php get_ram_chart($lang); ?>
                        </div>
                    </div>                
                </div>
				<div class="dr"><span></span></div>
                <div class="row-fluid">
                    <div class="span4">
                        <div class="head clearfix">
                            <i class="fa fa-hdd-o fa-1x"></i><span><?php echo get_lang($lang, 'inter01'); ?> #1</span>
                        </div>
                        <div class="block-fluid">
                            <?php disk_widget_chart('C:',$lang); ?> 
                        </div>
                    </div>
                    <div class="span4">
                        <div class="head clearfix">
                            <i class="fa fa-hdd-o fa-1x"></i><span><?php echo get_lang($lang, 'inter01'); ?> #2</span>
                        </div>
                        <div class="block-fluid">
                            <?php disk_widget_chart('D:',$lang); ?> 
                        </div>
                    </div>
                    <div class="span4">
                        <div class="head clearfix">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="head clearfix">
                            <i class="fa fa-info-circle fa-1x"></i><span><?php echo get_lang($lang, 'inter45'); ?></span>
                        </div>
                        <div class="block-fluid">
                            <?php net_widget($lang); ?>
                        </div>
