...
include('includes/demo_functions.php');
$url1 = "demo_live_outside.php?lang=bg&line=Strellson/Joop1&id=0&tk=tk1";
$line = ""; $kline = "";
?>
<head>        
	...
	<script type='text/javascript' src='js/plugins/c/t.js'></script>
	<script type='text/javascript' src='js/plugins/c/s.js'></script>
        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="page-header">
                    <h1><?php echo get_lang($lang, 'ad237'); ?></h1>
                </div> 
				
				<div class="row-fluid"> 
				    <div class="span4">
                        <div class="head clearfix">
                            <i class="fa fa-dashboard fa-1x"></i><span><?php echo get_lang($lang, 'ad269'); ?> 1</span>
                        </div>
						<div class="block">
                                <?php 
								    get_vmeter_220_r($lang,215);
								    get_amperage_r($lang,31);
									get_meter_r($lang,0.14);
								?>
						</div>
					</div>
				    <div class="span4">
                        <div class="head clearfix">
                            <i class="fa fa-dashboard fa-1x"></i><span><?php echo get_lang($lang, 'ad269'); ?> 2</span>
                        </div>
						<div class="block">
                                <?php 
								    get_vmeter_220_r($lang,218);
								    get_amperage_r($lang,32);
									get_meter_r($lang,0.14);
								?>
						</div>
					</div>
				    <div class="span4">
                        <div class="head clearfix">
                            <i class="fa fa-dashboard fa-1x"></i><span><?php echo get_lang($lang, 'ad269'); ?> 3</span>
                        </div>
						<div class="block">
                                <?php 
								    get_vmeter_220_r($lang,216);
								    get_amperage_r($lang,30);
									get_meter_r($lang,0.13);
								?>
						</div>
					</div>
				</div>
                <div class="row-fluid">        
				    <div class="span7">
                        <div class="head clearfix">
                            <i class="fa fa-bar-chart-o fa-1x"></i><span><?php echo get_lang($lang, 'ad270'); ?></span>
                        </div>
                        <div class="block">
                                <?php get_hled($lang); ?>
                        </div>
				    ...
				    <div class="span5">
                        <div class="head clearfix">
                            <i class="fa fa-trello fa-1x"></i><span><?php echo get_lang($lang, 'ad271'); ?></span>
                        </div>
                        <div class="block">
                                <?php get_odometer_r($lang,1371157200); ?>
                        </div>
                    </div>
                </div>         
