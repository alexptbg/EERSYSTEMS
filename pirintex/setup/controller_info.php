...
<?php
    ...
    echo "
                        <div class='head clearfix'>
                            <i class='fa fa-info-circle fa-1x'></i><span>".get_lang($lang, 'info1')."</span>
                            <ul class='buttons'>
                                <li class=\"tip-\" title=\"".get_lang($lang, 'ad199')."\">
                                    <a href=\"controller_photo_update.php?lang=".$lang."&line=".$line."&inv=".$inv."&sys=".$sys."&id=".$id."\" class=\"isw-picture\"></a>
                                </li>
                                <li class='tip-' title='".get_lang($lang, 'Edit')."'>
                                    <a href='controller_edit.php?lang=".$lang."&line=".$line."&inv=".$inv."&sys=".$sys."&id=".$id."' class='isw-edit'></a>
                                </li>
                                <li class='tip-' title='".get_lang($lang, 'Print')."'>
                                  <a target='_blank' href='print_controller.php?line=".$line."&lang=".$lang."&inv=".$inv."&sys=".$sys."&id=".$id."' class='isw-print'></a>
                                </li>
                            </ul> 
                        </div>
...
echo "
	...
	echo "
	<button class='btn btn-default' onClick='document.location.href = \"controller_edit.php?lang=".$lang."&line=".$line."&inv=".$inv."&sys=".$sys."&id=".$id."\"; return false;'><i class='fa fa-edit'></i>&nbsp; ". get_lang($lang, 'inter125')."</button>
    </div>
	  </div>";
	} else {
		$line_options = get_line_options($line);
		echo "
                        <div class='head clearfix'>
                            <i class='fa fa-info-circle fa-1x'></i><span>".get_lang($lang, 'info1')."</span></h1>
                        </div>
		    <div class='block-fluid'><br/><div class='w94'>";
	    echo get_info($lang, '1005')."\n";
		echo "<br/>";
        echo "</div>
              <div class='head clearfix'>
                  <i class='fa fa-plus fa-1x'></i><span>".get_lang($lang, 'inter86')."</span>
              </div>
<form action='controller_add.php?lang=".$lang."&line=".$line."&inv=".$inv."&sys=".$sys."&id=".$id."' method='post' id='validation'>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info3').":</div>
    <div class='span8'>
	<input name='inv' type='text' class='validate[required]' MAXLENGTH='6' value='$inv' readonly='readonly' /></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info4').":</div>
    <div class='span8'>
	<input name='main_line' type='text' class='validate[required]' value='".$line."' readonly='readonly' /></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info5').":</div>
    <div class='span8'>
	<input name='linex' type='text' class='validate[required]' value='' MAXLENGTH='32' />
	<span>".get_lang($lang, 'Example').": Joop</span></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info6').":</div>
    <div class='span8'>
	<input id='from' name='from' type='text' MAXLENGTH='10' value='' readonly='readonly' />
	<span>".get_lang($lang, 'Example').": 2010-11-20</span></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info7').":</div>
    <div class='span8'>
	<input name='mark' type='text' MAXLENGTH='32' value='' />
	<span>".get_lang($lang, 'Example').": BRISAY</span></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info8').":</div>
    <div class='span8'>
	<input name='type' type='text' MAXLENGTH='32' value='' />
	<span>".get_lang($lang, 'Example').": BRI-860</span></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info9').":</div>
    <div class='span8'>
	<textarea name='desc' type='text' placeholder='".get_lang($lang, 'inter122')."...' MAXLENGTH='256' value='' /></textarea></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info10').":</div>
    <div class='span8'>
	<input name='machine' type='text' MAXLENGTH='32' value='' />
	<span>".get_lang($lang, 'Example').": 4455/97</span></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info11').":</div>
    <div class='span8'>
	<input name='serial' type='text' MAXLENGTH='32' value='' />
...
<div class='row-form clearfix'>
    ...
    <div class='span8'>
	<input name='t1' type='text' MAXLENGTH='64' value='' />
...
<div class='row-form clearfix'>
    ...
    <div class='span8'>
	<input name='t2' type='text' MAXLENGTH='64' value='' />
...
<div class='row-form clearfix'>
    ...
    <div class='span8'>
	<input name='t3' type='text' MAXLENGTH='64' value='' />
...
<div class='row-form clearfix'>
    ...
    <div class='span8'>
	<input name='t4' type='text' MAXLENGTH='64' value='' />
...
<div class='row-form clearfix'>
    ...
    <div class='span8'>
	<input name='t5' type='text' MAXLENGTH='64' value='' />
...
<div class='row-form clearfix'>
    ...
    <div class='span8'>
	<input name='mobile' type='text' MAXLENGTH='128' value='' />
