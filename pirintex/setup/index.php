...
<body>
    <div class="errorPage">        
        <p class="name"><img src="img/error.png" /></p>
        <h3 class="title"><?php echo get_lang($lang, '1020'); ?></h3>
        <p class="description"><?php echo get_lang($lang, '1019'); ?></p><br/>	        
        <p><button class="btn btn-danger" onClick="document.location.href = '../index.php?lang=<?=$lang?>'; return false;">
		   <i class="fa fa-home"></i>&nbsp; <?php echo get_lang($lang, 'inter139'); ?></button> 
		   <button class="btn btn-warning" onClick="history.back(-1); return false;">
		   <i class="fa fa-arrow-left"></i>&nbsp; <?php echo get_lang($lang, 'Back'); ?></button></p>
    </div>
</body>
</html>