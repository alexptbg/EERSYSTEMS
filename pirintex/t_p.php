...
echo "<script type='text/javascript' src='js/table.js'></script>";
  ...
  <th class='tip_' title='". get_lang($lang, 'td51') ."'>SC1</th>
  <th class='tip_' title='". get_lang($lang, 'td52') ."'>SC2</th>
  <th class='tip_' title='". get_lang($lang, 'td53') ."'>SC3</th>
  <th class='tip_' title='". get_lang($lang, 'td54') ."'>SC4</th>
  <th class='tip_' title='". get_lang($lang, 'td55') ."'>SC5</th>
  <th class='tip_' title='". get_lang($lang, 'td56') ."'>SC6</th>
  </tr></thead>
  <tfoot><tr>
  <th class='tip' title='". get_lang($lang, 'td4') ."'>INV</th>
  <th class='tip' title='". get_lang($lang, 'td5') ."'>ID</th>
...
function table($dev,$line,$lang,$i,$red,$ala,$ex,$ex2,$ip,$port,$ex3) {
	...
	else { echo "<td class='td1 tip' title='".get_lang($lang,'td40')."'>$dev[21]</td>"; }//tk6 end
