        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="head clearfix">
                            <i class="fa fa-info-circle fa-1x"></i><span><?php echo get_lang($lang, 'ad322'); ?></span>
              <ul class="buttons">
                  <li class="tip_" title="<?php echo get_lang($lang, 'inter05'); ?>">
                      <a href="javascript: history.go(-1)" class="isw-left_circle"></a>
                  </li>
                  <li class="tip_" title="<?php echo get_lang($lang, 'Print'); ?>">
                      <a target="_blank" href="print_k_info.php?lang=<?=$lang?>&inv=<?=$inv?>&kline=<?=$krouter?>" class="isw-print"></a>
                  </li>
              </ul>   
                        </div>
