...
var odometer = function (ctx, parameters) {
    ...
    var height = (undefined === parameters.height ? 60 : parameters.height);
    var digits = (undefined === parameters.digits ? 9 : parameters.digits);
    var decimals = (undefined === parameters.decimals ? 3 : parameters.decimals);
