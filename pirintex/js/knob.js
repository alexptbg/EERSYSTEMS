            ...
            this.o = $.extend(
                {
                    ...
                    font_size : this.$.data('font-size') || 14,
					font_family : this.$.data('font-family') || 'Arial',
                    // UI
					...
					font_color : this.$.data('font-color') || this.$.data('inputcolor') || this.$.data('fgcolor') || '#87CEEB',
                    inline : false,
        ...
        this.init = function () {
            ...
            this.o.displayInput
                && this.i.css({
                        ...
                        ,'font' : 'bold ' + this.o.font_size + 'px ' + this.o.font_family						
                        ,'text-align' : 'center'
                        ,'color' : this.o.font_color || this.o.inputColor || this.o.fgColor
                        ,'padding' : '0px'
						,'text-shadow' : '-1px -1px 1px #CCCCCC, 1px 1px 1px #000000'
