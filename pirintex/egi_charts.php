        ...
        <div class="content">
            ...
            <div class="workplace">
                ...
                <div class="row-fluid">
                    <div class="span3">
                        <div class="head clearfix">
                            <i class="fa fa-circle-o fa-1x"></i><span><?php echo get_lang($lang, 'egi02'); ?> 1</span>
                        </div>
                        <div class="block">
                            <?php get_bar($lang,'Boss2','2','tk1'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                            <i class="fa fa-circle-o fa-1x"></i><span><?php echo get_lang($lang, 'egi02'); ?> 2</span>
                        </div>
                        <div class="block">
                            <?php get_bar($lang,'Boss2','2','tk2'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                            <i class="fa fa-bullseye fa-1x"></i><span><?php echo get_lang($lang, 'egi03'); ?></span>
                        </div>
                        <div class="block">
                            <?php get_gauge_tempbar_160($lang,'Boss2','2','tk1'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                            <i class="fa fa-asterisk fa-1x"></i><span><?php echo get_lang($lang, 'egi04'); ?></span>
                        </div>
                        <div class="block">
                            <?php get_bar($lang,'Boss2','2','tk5'); ?>
                        </div>
                    </div>
  <div class="footer fr">
      <button class="btn btn-default" type="button" onClick="javascript: history.go(-1); return false;">
        <i class="fa fa-arrow-left"></i>&nbsp; <?php echo get_lang($lang, 'Back'); ?></button>
                ...
                <div class="row-fluid">
                    <div class="span3">
                        <div class="head clearfix">
                            <i class="fa fa-circle-o fa-1x"></i><span><?php echo get_lang($lang, 'egi02'); ?></span>
                        </div>
                        <div class="block">
                            <?php get_bar($lang,'Boss2','2','tk3'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                            <i class="fa fa-bullseye fa-1x"></i><span><?php echo get_lang($lang, 'egi03'); ?> 1</span>
                        </div>
                        <div class="block">
                            <?php get_gauge_tempbar_160($lang,'Boss2','2','tk3'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                            <i class="fa fa-bullseye fa-1x"></i><span><?php echo get_lang($lang, 'egi03'); ?> 2</span>
                        </div>
                        <div class="block">
                            <?php get_gauge_tempbar_160($lang,'Boss2','2','tk4'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
        ...
        <i class="fa fa-arrow-left"></i>&nbsp; <?php echo get_lang($lang, 'Back'); ?></button>
                ...
                <div class="row-fluid">
                    <div class="span3">
                        ...
                        <div class="block">
                            <?php get_bar($lang,'Strellson/Joop2','4','tk3'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                        ...
                        <div class="block">
                            <?php get_gauge_tempbar_160($lang,'Strellson/Joop2','4','tk3'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                        ...
                        <div class="block">
                            <?php get_bar($lang,'Strellson/Joop2','4','tk4'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                            <i class="fa fa-bolt fa-1x"></i><span><?php echo get_lang($lang, 'Controller')." ".get_lang($lang, 'Voltage'); ?></span>
                        </div>
                        <div class="block">
                            <?php get_vmeter_24_r($lang); ?>
                        </div>
                    </div>
  <div class="footer fr">
      <button class="btn btn-default" type="button" onClick="javascript: history.go(-1); return false;">
        <i class="fa fa-arrow-left"></i>&nbsp; <?php echo get_lang($lang, 'Back'); ?></button>
                ...
                <div class="row-fluid">
                    <div class="span3">
                        ...
                        <div class="block">
                            <?php get_bar($lang,'Strellson/Joop2','4','tk1'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                        ...
                        <div class="block">
                            <?php get_bar($lang,'Strellson/Joop2','4','tk2'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                        ...
                        <div class="block">
                            <?php get_gauge_tempbar_160($lang,'Strellson/Joop2','4','tk1'); ?>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="head clearfix">
                        ...
                        <div class="block">
                            <?php get_bar($lang,'Strellson/Joop2','4','tk5'); ?>
                        </div>
                    </div>
  <div class="footer fr">
      <button class="btn btn-default" type="button" onClick="javascript: history.go(-1); return false;">
