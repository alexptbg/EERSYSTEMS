                        ...
                        <div class=\"row-fluid\">
                            <div class=\"span3\">
                                <div class=\"ucard clearfix\">                                    
                                    <div class=\"right\">
                                        <h4>".$user_settings['user_name']."</h4>
                                        <div class=\"image\">
                                            <img src=\"image.php?username=".$user_settings['user_name']."\" class=\"img-polaroid\" />                         
                                        </div>
										<button type=\"submit\" name=\"submit\" value=\"submit\" class=\"btn btn-small btn-default\" onClick=\"document.location.href = 'my_edit.php?lang=".$lang."'; return false;\">
		                                    <i class=\"fa fa-edit\"></i>&nbsp; ".get_lang($lang, 'Edit')."</button>
                                    </div>
                                </div>                                 
                            </div>                                                                                
                            <div class=\"span9\">
                    ...
                    <div class=\"span6\">        
                        ...
                        <div class=\"block-fluid scrollBox withList\">
                            <div class=\"scroll\" style=\"height: 280px;\">
                                <ul class=\"list\">";
                                    get_user_log($lang,$user_settings['user_name']);
                          echo "</ul>    
                            </div>                                                                                                                            
                        </div>
                    </div>";
