        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="head clearfix">
                            <i class="fa fa-list-ul fa-1x"></i><span><?php echo get_lang($lang, 'ad54'); ?></span>
                        </div>                  
                        <div class="block-fluid table-sorting clearfix">
                            <table cellpadding="0" cellspacing="0" width="100%" class="table" id="lines_t">
                                <thead>
                                    <tr>
                                        <th><?php echo get_lang($lang, 'ad35'); ?></th>
                                ...
                                <tbody>
                                    <?php get_lines($lang,$user_settings['level']); ?>
                                </tbody>
                            </table>
                            <div class="footer"> 
							<?php
							if ($user_settings['level']>4) {
                                ...
                                <button class=\"btn btn-default\" onClick=\"document.location.href = 'line_add.php?lang=".$lang."'; return false;\">
								    <i class=\"fa fa-plus\"></i>&nbsp; ".get_lang($lang, 'ad34')."</button>";
							} else {
								echo "
