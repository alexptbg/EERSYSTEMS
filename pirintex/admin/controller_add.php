        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    ...
                    <div class="span12">                    
                        <div class="head clearfix">
                            <i class="fa fa-plus fa-1x"></i><span><?php echo get_lang($lang, 'inter86'); ?></span>
                            <ul class="buttons">
...
echo "
<form action='controller_insert.php?lang=".$lang."&line=".$line."' method='post' id='validation'>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info3').":</div>
    <div class='span7'>
	<input id='inv' name='inv' type='text' class='validate[required],custom[onlyNumberSp]' MAXLENGTH='6' value='' /></div>
	<div class='span1'><span id='status'></span></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info4').":</div>
    <div class='span8'>
	<input id='linename' name='main_line' type='text' class='validate[required]' value='".$line."' readonly='readonly' /></div>
</div>
<div class='row-form clearfix'>
...
<div class='row-form clearfix'>
    ...
    <div class='footer'>
		...
		<i class='fa fa-plus'></i>&nbsp; ".get_lang($lang, 'inter86')."</button>
							    ";
							} else {
								echo "
...
$("#inv").html('<img src="img/loaders/s_loader_bw.gif" />');
			$.ajax({
				url: 'controller_check.php?linename='+linename+'&inv='+inv,
				type: 'POST',
