        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    ...
                    <div class="span12">                    
                        <div class="head clearfix">
                            <i class="fa fa-inbox fa-1x"></i><span><?php echo get_lang($lang, 'inter125'); ?></span>
                            <ul class="buttons">
...
<?php
    ...
    $controller_data = get_controller_data($inv,$line);
        echo "
<form action='controller_update.php?lang=".$lang."&line=".$line."&inv=".$inv."' method='post' id='validation'>
