...
<body>
    <div class="loginBlock" id="login" style="display: block;">
		...
		<div class="dr"><span></span></div>
        <div class="loginForm">
            <form class="form-horizontal" action="check.php?lang=<?=$lang?>" method="POST" id="validation">
    ...
    <div class="loginBlock" id="forgot">
		...
		<div class="dr"><span></span></div>
        <div class="loginForm">
          <form class="form-horizontal" action="request_password.php?lang=<?=$lang?>" method="POST" id="validation2">
