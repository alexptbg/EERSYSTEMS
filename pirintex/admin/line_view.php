        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    ...
                    <div class="span12">                    
                        <div class="head clearfix">
                            <i class="fa fa-list-ul fa-1x"></i><span><?php echo $line; ?></span>
                            <ul class="buttons">
                                ...
                                <li class="tip-" title="<?php echo get_lang($lang, 'Edit'); ?>">
                                    <a href="line_edit.php?lang=<?=$lang?>&line=<?=$line?>" class="isw-edit"></a>
                                </li>
                                <li class="tip-" title="<?php echo get_lang($lang, 'Print'); ?>">
                                    <a target="_blank" href="print_line.php?line=<?=$line?>&lang=<?=$lang?>" class="isw-print"></a>
                                </li>
                            </ul>                        
                        </div>
                        <div class="block-fluid">
							...
							?>                   
                                <button class="btn btn-default" onClick="document.location.href = 'line_edit.php?lang=<?=$lang?>&line=<?=$line?>'; return false;">
								<i class="fa fa-edit"></i>&nbsp; <?php echo get_lang($lang, 'ad49'); ?></button>
                            </div>                                                
                        </div>
                    </div>                                
                </div>   
