        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    <div class="span12">                    
                        <div class="head clearfix">
                            <i class="fa fa-user fa-1x"></i><span><?php echo get_lang($lang, 'ad11'); ?></span>
                            <ul class="buttons">
                        ...
                        <div class="block-fluid">                        
                          <form action="user_insert.php?lang=<?=$lang?>" method="post" id="validation">
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'Username'); ?>:</div>
                                <div class="span7">
								<input id="user_name" name="user_name" type="text" class="validate[required,minSize[4]],custom[onlyLetterNumber]" value="" MAXLENGTH="32" /></div>
								<div class="span1"><span id="status"></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'Password'); ?>:</div>
                                <div class="span8"><input id="password" name="password" type="password" class="validate[required,minSize[4]]" value="" MAXLENGTH="32" /></div>
                            </div>                         
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad12'); ?>:</div>
                                <div class="span8"><input name="password2" type="password" class="validate[required,equals[password]]" value="" MAXLENGTH="32" /></div>
                            </div> 
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad03'); ?>:</div>
                                <div class="span8"><input name="first_name" type="text" class="validate[required]" value="" MAXLENGTH="32" /></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad04'); ?>:</div>
                                <div class="span8"><input name="last_name" type="text" class="validate[required]" value="" MAXLENGTH="32" /></div>
                            </div> 
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad13'); ?>:</div>
                                <div class="span7"><input id="user_mail" name="email" type="text" class="validate[required,custom[email]]" value="" MAXLENGTH="64" /></div>
								<div class="span1"><span id="statusm"></span></div>
                            </div> 
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad14'); ?>:</div>
                                <div class="span8"><input name="s_email" type="text" value="" MAXLENGTH="64" /></div>
                            </div>                                                
                            <?php 
                            ...
                            <div class='row-form clearfix'>
                                ...
                                <div class='span8'>
                                    <select name='s_admin' class='validate[required]'>
                                        <option value=''>". get_lang($lang, 'ad16'). "...</option>
							...
							?>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad23'); ?>:</div>
                                <div class="span8"><input name="phone" type="text" value="" MAXLENGTH="32" /></div>
                            </div> 
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad24'); ?>:</div>
                                <div class="span8"><input name="info" type="text" value="" MAXLENGTH="64" /></div>
                            </div> 
                            <div class="footer">
...
if (username != null) {
$("#user_name").html('<img src="img/loaders/s_loader_bw.gif" />');
			$.ajax({
				url: 'user_check.php?username='+username,
				type: 'POST',
...
if (usermail != null) {
$("#user_mail").html('<img src="img/loaders/s_loader_bw.gif" />');
			$.ajax({
				url: 'user_check_mail.php?usermail='+usermail,
				type: 'POST',
				success: function(data) {
			$('span#statusm').html(data);
			},
				cache: false
			});
return false;
