        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="head clearfix">
                            <i class="fa fa-sitemap fa-1x"></i><span><?php echo get_lang($lang, 'ad301'); ?></span>
                            <ul class="buttons">
                        ...
                        <div class="block-fluid">
                          <form action="klima_router_insert.php?lang=<?=$lang?>" method="post" id="validation">
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad302'); ?>:</div>
                                <div class="span7">
								  <input id="router_name" name="router_name" type="text" class="validate[required,minSize[4]]" value="" MAXLENGTH="32" /><span><?php echo get_lang($lang, 'ad42'); ?></span></div>
								  <div class="span1"><span id="status"></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad36'); ?>:</div>
                                <div class="span8">
								  <input id="lsn" name="router_sname" type="text" class="validate[required,maxSize[8]]" oninput=" document.getElementById('echo').value=this.value+'.php';" value="" MAXLENGTH="8" />
...
$("#router_name").html('<img src="img/loaders/s_loader_bw.gif" />');
			$.ajax({
				url: 'klima_router_check.php?routername='+routername,
				type: 'POST',
