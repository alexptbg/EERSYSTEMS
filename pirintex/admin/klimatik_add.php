...
<?php
echo "
<form action='klimatik_insert.php?lang=".$lang."&krouter=".$krouter."' method='post' id='validation'>
...
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'ad302').":</div>
    <div class='span8'>
	<input id='router' name='router' type='text' class='validate[required]' value='".$krouter."' readonly='readonly' /></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info4').":</div>
    <div class='span8'>
	<input name='main_line' type='text' class='validate[required]' value='' MAXLENGTH='32' />
	<span>".get_lang($lang, 'Example').": Joop</span></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info5').":</div>
    <div class='span8'>
	<input name='line' type='text' class='validate[required]' value='' MAXLENGTH='32' />
	<span>".get_lang($lang, 'Example').": Joop</span></div>
</div>
<div class='row-form clearfix'>
...
<div class='row-form clearfix'>
    ...
    <div class='span8'>
	<input name='org' type='text' MAXLENGTH='48' readonly='readonly' value='".$krouter_options['org']."' /></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info20')." :</div>
    <div class='span8'>
	<input name='plant' type='text' MAXLENGTH='2' value='' /></div>
</div>
<div class='row-form clearfix'>
    <div class='span4 tar'>".get_lang($lang, 'info21')." :</div>
    <div class='span8'>
	<input name='floor' type='text' MAXLENGTH='2' value='' /></div>
</div>
    <div class='footer'>
...
$("#inv").html('<img src="img/loaders/s_loader_bw.gif" />');
			$.ajax({
				url: 'klimatik_check.php?router='+router+'&inv='+inv,
				type: 'POST',
