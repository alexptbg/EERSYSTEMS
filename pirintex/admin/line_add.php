        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="head clearfix">
                            <i class="fa fa-list-ul fa-1x"></i><span><?php echo get_lang($lang, 'ad34'); ?></span>
                            <ul class="buttons">
                        ...
                        <div class="block-fluid">
                          <form action="line_insert.php?lang=<?=$lang?>" method="post" id="validation">
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad35'); ?>:</div>
                                <div class="span7">
								  <input id="line_name" name="line_name" type="text" class="validate[required,minSize[4]]" value="" MAXLENGTH="32" /><span><?php echo get_lang($lang, 'ad42'); ?></span></div>
								  <div class="span1"><span id="status"></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad36'); ?>:</div>
                                <div class="span8">
								  <input id="lsn" name="line_sname" type="text" class="validate[required,maxSize[8]]" oninput=" document.getElementById('echo').value=this.value+'.php';" value="" MAXLENGTH="8" />
								  <span><?php echo get_lang($lang, 'ad48'); ?></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad37'); ?>:</div>
                                <div class="span8">
								  <input id="echo" name="data_file" type="text" class="validate[required]" value="" readonly="readonly" /></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad38'); ?>:</div>
                                <div class="span8">
								 <input name="ip_address" type="text" class="validate[required,custom[ipv4]]" value="" MAXLENGTH="15" />
								 <span><?php echo get_lang($lang, 'ad48'); ?></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad39'); ?>:</div>
                                <div class="span8">
								  <input name="port" type="text" class="validate[required,custom[number]]" value="" MAXLENGTH="5" />
								  <span><?php echo get_lang($lang, 'ad48'); ?></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad40'); ?>: +</div>
                                <div class="span8">
								  <input name="alarm" type="text" class="validate[required]" value="25" MAXLENGTH="2" />
								  <span><?php echo get_lang($lang, 'ad47'); ?></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad41'); ?>: +</div>
                                <div class="span8">
								  <input name="red" type="text" class="validate[required]" value="15" MAXLENGTH="2" />
								  <span><?php echo get_lang($lang, 'ad47'); ?></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad43'); ?>:</div>
                                <div class="span8">
								  <input name="ex_alarm" type="text" value="" />
								  <span><?php echo get_lang($lang, 'ad46'); ?></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad44'); ?>:</div>
                                <div class="span8">
								  <input name="ex_red" type="text" value="" />
								  <span><?php echo get_lang($lang, 'ad46'); ?></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'ad45'); ?>:</div>
                                <div class="span8">
								  <input name="ex_table" type="text" value="" />
								  <span><?php echo get_lang($lang, 'ad46'); ?></span></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span4 tar"><?php echo get_lang($lang, 'info19'); ?>:</div>
                                <div class="span8">
								  <input name="org" type="text" value="" />
								</div>
                            </div>
                            <div class="row-form clearfix">
                            ...
                            <div class="row-form clearfix">
								...
								&nbsp;<input type="checkbox" name="lt_s" value="yes" checked="checked" /></div>
                            ...
                            <div class="row-form clearfix">
								...
								&nbsp;<input type="checkbox" name="mod_s" value="yes" checked="checked" /></div>
                                <div class="span2 tar"><span><?php echo get_lang($lang, 'ad157'); ?></span></div>
                                <div class="span2">
                            ...
                            <div class="row-form clearfix">
								...
								&nbsp;<input type="checkbox" name="time_s" value="yes" checked="checked" /></div>
                                <div class="span2 tar"><span><?php echo get_lang($lang, 'ad157'); ?></span></div>
                                <div class="span2">
...
$("#line_name").html('<img src="img/loaders/s_loader_bw.gif" />');
			$.ajax({
				url: 'line_check.php?linename='+linename,
				type: 'POST',
