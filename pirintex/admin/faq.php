                            ...
                            <div class="faq">
                                <div class="item" id="faq-1">
                                    ...
                                    <div class="text">
										...
										<p>Google Chrome 3.0+ / Firefox 16.0+ / Internet Explorer 9+ / Safari 4.0+ / Opera 11.0+</p>
										<p><strong><?php echo get_lang($lang, 'faq03'); ?></strong>:</p>
										<p>Firefox 21.0+</p>
										<div class="dr"><span></span></div>
									...
									<div class="item" id="faq-2">
										<div class="title"><?php echo get_lang($lang, 'faq10'); ?></div>
										<div class="text">
							<h5><?php echo get_lang($lang, 'faq21'); ?></h5>
                            <p><span class="label label-info">1</span>&nbsp;<i class="fa fa-arrow-right"></i>&nbsp;<?php echo get_lang($lang, 'faq11'); ?><br/>
                                    <?php echo get_lang($lang, 'faq18'); ?></p>
                            <p><span class="label label-info">3</span>&nbsp;<i class="fa fa-arrow-right"></i>&nbsp;<?php echo get_lang($lang, 'faq12'); ?><br/>
                                    <?php echo get_lang($lang, 'faq19'); ?></p>
                            <p><span class="label label-info">4</span>&nbsp;<i class="fa fa-arrow-right"></i>&nbsp;<?php echo get_lang($lang, 'faq13'); ?><br/>
                                    <?php echo get_lang($lang, 'faq20'); ?></p>
                            <p><span class="label label-info">5</span>&nbsp;<i class="fa fa-arrow-right"></i>&nbsp;<?php echo get_lang($lang, 'faq14'); ?><br/>
                                    <?php echo get_lang($lang, 'faq22'); ?></p>
                          <p><span class="label label-info">10</span>&nbsp;<i class="fa fa-arrow-right"></i>&nbsp;<?php echo get_lang($lang, 'faq15'); ?><br/>
                                  <?php echo get_lang($lang, 'faq23'); ?></p>
                          <p><span class="label label-info">50</span>&nbsp;<i class="fa fa-arrow-right"></i>&nbsp;<?php echo get_lang($lang, 'faq16'); ?><br/>
                                  <?php echo get_lang($lang, 'faq24'); ?></p>
                          <p><span class="label label-info">100</span>&nbsp;<i class="fa fa-arrow-right"></i>&nbsp;<?php echo get_lang($lang, 'faq17'); ?><br/>
                                  <?php echo get_lang($lang, 'faq25'); ?></p>
										</div>
									</div>
                                </div>
                            </div>
