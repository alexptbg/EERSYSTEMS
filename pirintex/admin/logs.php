        ...
        <div class="content">
            ...
            <div class="workplace">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">                    
                        <div class="head clearfix">
                            <i class="fa fa-list-alt fa-1x"></i><span><?php echo get_lang($lang, 'ad120'); ?></span>                            
                        </div>
                        <div class="block-fluid table-sorting clearfix">
                            <table cellpadding="0" cellspacing="0" width="100%" class="table" id="logs_t">
                                <thead>
                                    <tr>
                                        <th><?php echo get_lang($lang, 'inter71'); ?></th>
                                        <th><?php echo get_lang($lang, 'info6'); ?></th>
                                        <th><?php echo get_lang($lang, 'inter72'); ?></th>
                                        <th><?php echo get_lang($lang, 'Username'); ?></th>
										<th><?php echo get_lang($lang, 'ad121'); ?></th>                         
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php get_all_logs($lang); ?>
                                </tbody>
                            </table>
                            <div class="footer"> 
							<?php
							if ($user_settings['level']>10) {
                                ...
                                <button class=\"btn btn-warning\" onClick=\"confirma(); return false;\">
								    <i class=\"fa fa-times\"></i>&nbsp; "
									.get_lang($lang,'ad122')." <small>(".decodeSize(get_table_size('logs')).")</small></button>
								";
							} else {
								echo "
								<span class=\"fl label label-important\">". get_lang($lang, 'ad136').": 50</span>
                                <button class=\"btn btn-default\" onClick=\"confirma(); return false;\" disabled=\"disabled\" disabled>
								    <i class=\"fa fa-times\"></i>&nbsp; "
									.get_lang($lang,'ad122')." <small>(".decodeSize(get_table_size('logs')).")</small></button>
								";
							}
...
function confirma() {
	var answer = confirm(\"".get_lang($lang, 'ad123')."?\");
	if (answer){ clear_log(); }
	else{ alert(\"".get_lang($lang, 'ad124')."\"); }
}
function clear_log() {
   $.ajax({
   type: \"POST\",
   url: \"logs_clear.php?lang=".$lang."\",
   success: function(){
	 alert(\"".get_lang($lang, 'ad125')."\");
     var delay = 1000;
     setTimeout(function(){ window.location.href = 'logs.php?lang=".$lang."'; }, delay);
   }
 });
    return false;
}
