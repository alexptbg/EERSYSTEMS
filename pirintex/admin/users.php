        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    ...
                    <div class="span12">                    
                        <div class="head clearfix">
                            <i class="fa fa-group fa-1x"></i><span><?php echo get_lang($lang, 'ad02'); ?></span>                           
                        </div>
                        <div class="block-fluid table-sorting clearfix">
                            <table cellpadding="0" cellspacing="0" width="100%" class="table" id="users_t">
                                <thead>
                                    <tr>
                                        <th>&nbsp;</th>
                                        <th><?php echo get_lang($lang, 'Username'); ?></th>
                                        <th><?php echo get_lang($lang, 'ad03'); ?></th>
                                        <th><?php echo get_lang($lang, 'ad04'); ?></th>
                                        <th><?php echo get_lang($lang, 'ad05'); ?></th>
										<th><?php echo get_lang($lang, 'inter134'); ?></th>
										<th><?php echo get_lang($lang, 'Status'); ?></th>
										<th><?php echo get_lang($lang, 'Controls'); ?></th>                            
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php get_users($lang,$user_settings['level']); ?>
                                </tbody>
                            </table>
                            <div class="footer">
							<?php
							...
							?>                       
                                <button class="btn btn-default" onClick="document.location.href = 'user_add.php?lang=<?=$lang?>'; return false;">
								    <i class="fa fa-plus"></i>&nbsp; <?php echo get_lang($lang, 'ad11'); ?></button>
                            </div>
                        </div>
                    </div>                                
                </div>   
