        ...
        <div class="content">
            ...
            <div class="workplace">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="head clearfix">
                            <i class="fa fa-square fa-1x"></i><span><?php echo $kline; ?></span>
                            <ul class="buttons">
                                ...
                                <li class="tip-" title="<?php echo get_lang($lang, 'td41'); ?>">
                                    <a target="_blank" href="print_k_table.php?kline=<?=$kline?>&lang=<?=$lang?>" class="isw-print"></a>
                                </li>
                            </ul>
                        </div>
                        <div class="block">
                            <?php get_klimatik_data($lang,$kline,$l); ?>
                        </div>
                    </div>		 
                </div>
